...
<body class="hold-transition layout-top-nav layout-navbar-fixed">
  <div class="wrapper">
                  ...
                  <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-info">
                      <div class="inner">
                        ...
                        $total_kamar = mysqli_num_rows($data);
                        ?>
                        <h3><?= $total_kamar ?></h3>
                  ...
                  <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-info">
                      ...
                      <?php
                        ...
                        $data = mysqli_query($koneksi, $query);
                        $fasilitas_kamar = mysqli_num_rows($data);
                        ?>
                        <h3><?= $fasilitas_kamar ?></h3>
                  ...
                  <div class="col-lg-3 col-6">
                    ...
                    <div class="small-box bg-info">
                      ...
                      <?php
                        ...
                        $data = mysqli_query($koneksi, $query);
                        $total_galeri = mysqli_num_rows($data);
                        ?>
                        <h3><?= $total_galeri ?></h3>
    ...
    <footer class="main-footer">
      ...
      <!-- Default to the left -->
      <strong>Copyright &copy; 2014-2021 <a href="https://adminlte.io">Alberich.com</a>.</strong> All rights reserved.
    </footer>
  </div>
  <!-- ./wrapper -->
