            ...
            <div class="card card-outline card-info">
              <div class="card-body">
                <table class="table table-bordered">
                  <!-- search -->
                  <div class="topnav">
                    <input type="text" placeholder="Search.." id="myinput" onkeyup="myFuction()">
                  </div>
                  <br>
                  <thead>
                    <tr>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <?php } else if ($d['status'] == 2) {?>
                            <span class="badge bg-warning">Sudah di Konfirmasi </span>
                          <?php } else { ?>
                        ...
                        <td>
                          ...
                          <a href="hapus.php?id_pesanan=<?php echo $d['id_pesanan']; ?>" class="btn btn-sm btn-danger"
                           onclick=" return confirm('Anda Yakin akan menghapus data ini?')">Finish</a>
                        </td>
                      </tr>
                      <?php
                    }
